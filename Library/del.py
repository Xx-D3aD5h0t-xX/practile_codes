...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        self.check_frame = ttk.LabelFrame(self, text="Checkbuttons")
        ...
        self.separator.grid(row=1, column=0, padx=(
            20, 10), pady=10, sticky="ew")

        # Create a Frame for the Radiobuttons
        self.radio_frame = ttk.LabelFrame(
            self, text="Radiobuttons", padding=(20, 10))
        self.radio_frame.grid(row=2, column=0, padx=(
        ...
        self.spinbox = ttk.Spinbox(
            self.widgets_frame, from_=0, to=100, increment=0.1)
        ...
        self.paned.grid(row=0, column=2, pady=(
...
if __name__ == "__main__":
    ...
    root.tk.call("source", r".\\library\\azure.tcl")
